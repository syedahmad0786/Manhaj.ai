...
export const LAYERS: readonly Layer[] = [
  ...
  },
  {
    ...
    summary: 'AI-assisted scoring against your ICP, with measurable response targets and an explicit route for every outcome.',
    detail: 'Captured leads can be enriched and scored against your custom ICP against a response-time target agreed for the implementation. Routing is explicit: qualified leads can page a human or an approved AI agent; other leads can enter an appropriate nurture path.',
  ...
  },
  {
    ...
    summary: 'Multi-channel response against an agreed service target. Voice AI can handle approved missed-call paths while context persists across handoffs.',
    detail: 'Speed-to-lead targets are configured by channel and operating constraint. An approved AI voice agent can handle missed-call paths; SMS, email, and WhatsApp can converge on a shared record, with relevant context available at human handoff.',
